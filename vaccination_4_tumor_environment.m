...
for i = 1:len
    ...
    annotation('textbox', [0.05, 0.83, 0.1, 0.05], ...
               ...
               'FontWeight', 'normal', ...
               'FontName', 'Helvetica');
    title('Vaccination Scenario 4 (Doses at 7 and 14 days after Tumor Innoculation)', 'Color', 'w', 'FontSize', 16, 'FontWeight', 'bold');
    ...
    if t(i)>=14 && t(i)<=19
        string= sprintf('2nd dose of 1x10^6 dormant tumor cells');
        dimensions = [0.05 0.715 0.1 0.05];
        annotation('textbox',dimensions,'String',string,'FontSize',12,'FontWeight','normal', ...
        'EdgeColor','w','BackgroundColor','k','Color','w','FitBoxToText','on');
    end
...
movie = VideoWriter('Vaccination Scenario 4','MPEG-4');
movie.FrameRate = 10;
movie.Quality=100;
